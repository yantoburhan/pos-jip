                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="point" min="0" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="number" name="point" value="{{ old('point', $product->point) }}" />
                        </div>
